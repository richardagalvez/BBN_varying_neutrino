...
public:
	...
	void Init_cosmomodel_param(double eta, double nbnu, double nbnu_star, double life_neutron, double xinu1, double xinu2, double xinu3);
	...
	void Init_fierz(double eta, double nbnu, double nbnu_star, double life_neutron, double fierz);
