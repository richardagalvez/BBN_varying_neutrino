...
void CosmologyModel::Init_cosmomodel_param(double eta, double nbnu, double nbnu_star, double life_neutron, double xinu1, double xinu2, double xinu3)
...
void CosmologyModel::Init_fierz(double eta, double nbnu, double nbnu_star, double life_neutron, double fierz)
...
{
    Init_cosmomodel_param(eta, nbnu, nbnu_star, life_neutron, 0, 0, 0);
	this->fierz=fierz;
	return;
}
